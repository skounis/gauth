...
/**
 The base class for all gauth modules
 */
...
/**
 gauth Platform calls this method on startup.
 */
-(void)startup;

/**
 gauth Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 gauth Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 gauth Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 gauth Platform calls this method on resume.
 @param sender The sender of the event.
 */
