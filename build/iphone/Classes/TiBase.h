...
// in simulator we redefine to format for gauth Developer console
...
{\
	NSString * exceptionName = [@"org.gauth." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gauth";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIgauthNativeItemNone = -1, 
	UIgauthNativeItemSpinner = -2,
	UIgauthNativeItemProgressBar = -3,
	
	UIgauthNativeItemSlider = -4,
	UIgauthNativeItemSwitch = -5,
	UIgauthNativeItemMultiButton = -6,
	UIgauthNativeItemSegmented = -7,
	
	UIgauthNativeItemTextView = -8,
	UIgauthNativeItemTextField = -9,
	UIgauthNativeItemSearchBar = -10,
	
	UIgauthNativeItemPicker = -11,
	UIgauthNativeItemDatePicker = -12,
	
	UIgauthNativeItemInfoLight = -13,
	UIgauthNativeItemInfoDark = -14,
	
	UIgauthNativeItemDisclosure = -15,
	
	UIgauthNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all gauth instances of
